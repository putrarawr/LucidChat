...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-4 relative overflow-hidden bg-[var(--surface-0)]">
      ...
      {/* Main Glass Card */}
      <div className="relative z-10 w-full max-w-[400px] animate-glass-appear">
        <div className="liquid-glass-elevated p-9 text-center space-y-7 border border-white/[0.14]">
          
          {/* Brand Logo */}
          <div className="flex flex-col items-center gap-3.5">
            <div className="relative">
              <div className="w-[72px] h-[72px] rounded-[20px] bg-white/[0.06] border border-white/[0.14] flex items-center justify-center p-1.5 animate-pulse-glow overflow-hidden">
            ...
            <div className="space-y-1">
              <h1 className="text-[26px] font-bold tracking-[-0.03em] text-white">LucidChat</h1>
          ...
          {/* Feature Pills — icons, no emoji */}
          <div className="flex flex-wrap justify-center gap-2">
            <div className="flex items-center gap-1.5 px-3 py-1.5 rounded-full bg-white/[0.05] border border-white/[0.08] text-[11px] text-white/50 font-medium">
              <Zap className="w-3 h-3 text-white/45" />
              <span>15+ Model AI</span>
            </div>
            <div className="flex items-center gap-1.5 px-3 py-1.5 rounded-full bg-white/[0.05] border border-white/[0.08] text-[11px] text-white/50 font-medium">
              <ShieldCheck className="w-3 h-3 text-white/45" />
          ...
          <div className="flex items-center gap-4">
            ...
            <span className="text-[10px] text-white/22 uppercase tracking-[0.15em] font-medium">Login</span>
            <div className="flex-1 h-px bg-gradient-to-r from-transparent via-white/[0.08] to-transparent" />
          </div>
          ...
          >
            ...
            <div className="relative flex items-center justify-center gap-3 py-3.5 px-6 rounded-[15px] bg-white text-black font-semibold text-sm shadow-[0_0_30px_rgba(255,255,255,0.12)] group-hover:shadow-[0_0_40px_rgba(255,255,255,0.22)] transition-all duration-300">
              ...
              {!loading && (
                <svg className="w-4 h-4 text-black/35 group-hover:translate-x-0.5 transition-transform" fill="none" viewBox="0 0 24 24" strokeWidth="2" stroke="currentColor">
